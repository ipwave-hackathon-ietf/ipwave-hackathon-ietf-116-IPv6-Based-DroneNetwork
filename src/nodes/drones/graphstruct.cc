...
void spacegraph::buildgraphnodes1(std::map<std::string, Coord> nodes, Coord boundLim){
    std::cout <<"spacegraph.cc file!  Num Nodes = "<<nodes.size() <<"; Boundary = ("<<boundLim.x <<";"<<boundLim.y<<";"<<boundLim.z<<")"<<std::endl;
    int nx = boundLim.x + 1;
    int ny = boundLim.y + 1;
    int nz = boundLim.z + 1;
    double tx = 0;
...
void spacegraph::buildgraphnodes(std::map<std::string, Coord> dst, std::map<std::string, Coord> bst,  Coord boundLim){
    std::cout <<"spacegraph.cc file!  Num Dst = "<<dst.size() <<"; Boundary = ("<<boundLim.x <<";"<<boundLim.y<<";"<<boundLim.z<<")"<<std::endl;
    double sidesize = 10;
