...
#include "inet/networklayer/ipv6/Ipv6InterfaceData.h" //BAM Added for IPv6
...
{
    std::cout <<"+++ void LteMacUe::initialize(int stage) +++" <<std::endl;
...
//    }
    ...
    {
        std::cout << "11111  void LteMacUe::initialize(int stage)! " <<std::endl;
    ...
    {
        std::cout << "22222  void LteMacUe::initialize(int stage)! " <<std::endl;
        if (strcmp(getFullName(),"nrMac") == 0)
...
#ifdef IPv6Based
        std::cout << "333333  void LteMacUe::initialize(int stage)! " <<std::endl;
